...
static inline def_EHelper(gp3) {
  switch (s->isa.ext_opcode) {
    ...
    IDEXW(4, gp3_a, mul, id_dest->width) 
    IDEXW(5, gp3_a, imul1, id_dest->width) 
    IDEXW(6, gp3_a, div, id_dest->width) 
    IDEXW(7, gp3_a, idiv, id_dest->width)
  }
}
